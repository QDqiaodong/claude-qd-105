...
INSERT INTO transit_bag (code, chute_id, batch_id, load_plan_id, quantity, bag_date, status, operator) VALUES
('TB-0901', 3, 3, 1, 180, '2026-09-15', '已发车', '赵师傅'),
('TB-0902', 5, 4, 2, 60, '2026-09-16', '待发车', '赵师傅'),
('TB-0903', 5, 4, 2, 20, '2026-09-16', '已拆除', '赵师傅');
...
('EX-0903', 4, '无面单', '面单脱落查无收件人', '2026-09-16', '赵师傅', '待处理');
